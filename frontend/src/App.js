...
import {ridefairInterface} from './ridefair_sol_ridefair_abi.js'
import {
  initBlockchain,
  setDriver,
  requestRide,
...
class App extends Component {
  ...
  async loadBlockchainData() {
    ...
    const address = '0xb494b2Be7D9dDA392fAF3A4C6685EB9e4378da1A';

    const blockchainFunctions = await initBlockchain(portNumber, address, ridefairInterface);
    ...
    return (
      <div>
        ...
        <DriverProgressPage
          ...
          tripRate={this.state.tripRate}
          directions={this.state.directions}
          onDriverPaidListener={this.state.onDriverPaidListener}
